...
export class SchemasService {
  constructor(
    ...
    private httpDlpService: HttpDlpService,
  ...
  loadSchema(uid: string, format: 'xml' | 'json-ld') {
    return this.httpDlpService.getGraphDlpV3(uid, format);
  }
  ...
  getObjectValue(uidList: string[]) {
    return this.httpDlpService.getObjectValue(uidList);
  }
}
